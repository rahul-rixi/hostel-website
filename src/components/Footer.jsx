...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-200 text-gray-700 py-8" style={{ userSelect: 'none' }}>
      <div className="container mx-auto px-6 md:px-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Contact Details */}
          <div className="footer-text">
            <h3 className="text-xl font-bold mb-4 text-gray-800">Find Us On</h3>
            <p className="text-sm text-gray-600">Call us on: +91 123 456 7890</p>
            <p className="text-sm text-gray-600">
              Email us on:{" "}
        ...
        <div className="text-center mt-8 footer-text">
          ...
          <div className="flex justify-center space-x-6">
            <a href="https://facebook.com/gcearwal" className="text-gray-600 hover:text-blue-500 transition duration-200">
              <i className="fab fa-facebook-f"></i>
            </a>
            <a href="https://twitter.com/gcearwal" className="text-gray-600 hover:text-blue-500 transition duration-200">
              <i className="fab fa-twitter"></i>
            </a>
            <a href="https://instagram.com/gcearwal" className="text-gray-600 hover:text-blue-500 transition duration-200">
              <i className="fab fa-instagram"></i>
            </a>
            <a href="https://linkedin.com/school/gcearwal" className="text-gray-600 hover:text-blue-500 transition duration-200">
        ...
        {/* Copyright */}
        <div className="text-center mt-8 text-sm text-gray-600 footer-text">
